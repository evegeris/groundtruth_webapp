var app=angular.module("RDash.display",["ngRoute","react"]);app.config(["$routeProvider",function(a){a.when("/display",{templateUrl:"templates/display.html",controller:"DisplayCtrl"})}]),app.controller("DisplayCtrl",function(a){a.person={fname:"Clark",lname:"Kent"}}),app.directive("display-canvas",function(a){return a(Hello)});var ScaleCanvasToImage=React.createClass({propTypes:{imagefp:React.PropTypes.string.isRequired},render:function(){return React.DOM.span(null,"Hello "+this.props.fname+" "+this.props.lname)}});app.value("ScaleCanvasToImage",ScaleCanvasToImage);
...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/dashboard"),t.state("index",{url:"/",templateUrl:"templates/signin.html"}).state("tables",{url:"/tables",templateUrl:"templates/tables.html"}).state("dashboard",{url:"/dashboard",templateUrl:"templates/dashboard.html"}).state("signin",{url:"/signin",templateUrl:"templates/signin.html"}).state("display",{url:"/display",templateUrl:"templates/display.html"})}]);
"use strict";angular.module("RDash.signin",["ngRoute"]).config(["$routeProvider",function(n){n.when("/signin",{templateUrl:"templates/signin.html",controller:"SignInCtrl"})}]).controller("SignInCtrl",[function(){}]);
